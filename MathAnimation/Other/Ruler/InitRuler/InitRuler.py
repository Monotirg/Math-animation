...
class InitRuler(Scene):
    def construct(self):
        ...
        self.play(
            AnimationGroup(
                *[FadeIn(dot, shift=DOWN) for dot in dots_side], run_time=0.8
            )
        )
        self.play(
            AnimationGroup(
                *[FadeIn(dot, shift=DOWN) for dot in dots_div], lag_ratio=0.3
            ),
            run_time=2,
        ...
        self.play(
            AnimationGroup(
                *[FadeIn(dot, shift=DOWN) for dot in dots_subdiv], lag_ratio=0.3
            ),
            run_time=4,
            rate_func=rate_functions.smooth,
        )
